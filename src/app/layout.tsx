...
import { PopoverContent, PopoverTrigger, PopoverClose, Popover  } from "@/components/ui/popover";
                  ...
                  <Link className="flex flex-col items-center w-full px-3 py-4 text-center hover:bg-gray-100" href="#">
                    ...
                    <span className="text-2xl leading-none">Cadastros</span>
                      ...
                      {/* <Button className="w-full flex items-center gap-4 text-left">
                        Home
                        <IconHome className="ml-auto h-4 w-4" />
                      </Button> */}
                    </PopoverTrigger>
                    <PopoverContent align="start"  className="min-w-[200px] w-56 p-2 bg-slate-200 " side="right">
                      {/* <div>Home</div>
                      <div /> */}
