...
export default async function LancamentosPage() {
  return (
    <LancamentoProvider>
      <div className="overflow-x-auto min-w-screen  w-[90%] max-w-[1400px] min-w-[500px]">
        <div className="justify-items-center flex flex-col min-h-[80vh]md:justify-center md:px-6 md:gap-5">
